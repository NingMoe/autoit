...
$server_address="\\10.112.55.83\d$\apps\SyncBack\"
...
if FileExists($server_address&"Faresheet2_to_Faresheet_Log_Page1.html") then   ; D:\apps\SyncBack
	
	$t=FileGetTime($server_address&"Faresheet2_to_Faresheet_Log_Page1.html")
	...
	if $delta=0 then 
						...
						$s_AttachFiles = $server_address&"Faresheet2_to_Faresheet_Log_Page1.html"
						$rc = _INetSmtpMailCom($s_SmtpServer, $s_FromName, $s_FromAddress, $s_ToAddress, $s_Subject, $as_Body, $s_AttachFiles, $s_CcAddress, $s_BccAddress, $s_Username, $s_Password, $IPPort, $ssl)
