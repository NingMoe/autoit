...
$s_CcAddress = ""       ; address for cc - leave blank if not needed
$s_BccAddress = ""     ; address for bcc - leave blank if not needed
$s_Username = "ae_direct_fly@onlinebooking.com.tw"                    ; username for the account used from where the mail gets sent  - Optional (Needed for eg GMail)
...
for $r=1 to  3 ;(UBound($extramail_array,1)-1)
