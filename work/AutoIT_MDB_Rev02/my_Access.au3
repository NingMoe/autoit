...
Func Example_AccessOpen()
	...
	If $o_DataBase = 0 Then
		...
		Return
	Else
		MsgBox(0, "Information", "Database file was opened :-" & @CR & @ScriptDir & "\raidenmaild.mdb")
	EndIf
...
Func Example_AccessRecordsCount()
	...
	Local $n_RecCount = _AccessRecordsCount ($o_DataBase, "usertable")
...
Func Example_AccessFieldsList()
	...
	$avArray_Fields = _AccessFieldsList ($o_DataBase, "usertable")
...
Func Example_AccessRecordList()
	...
	$avArray_Record = _AccessRecordList ($o_DataBase, "usertable", 63)
